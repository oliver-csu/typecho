...
class Widget_Menu extends Typecho_Widget
{
    ...
    public function execute()
    {
        ...
        array(
            ...
            array(_t('设置'), _t('个人设置'), 'profile.php', 'subscriber'),
        ...
        array(
            ...
            array(_t('页面'), _t('管理独立页面'), 'manage-pages.php', 'editor', false, 'write-page.php'),
        ...
        array(
            ...
            array(_t('链接'), _t('永久链接设置'), 'options-permalink.php', 'administrator'),
        ));
